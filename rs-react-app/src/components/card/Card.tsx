						...
						<div className='text-gray-700 text-sm'>
							{this.state.pokeInfo.sprites.front_default ?
								(<img
									...
									src={this.state.pokeInfo.sprites.front_default} alt={this.state.pokeInfo.name}/>)
								: null}
							<p><span className='font-medium'>Weight: </span> {this.state.pokeInfo.weight}</p>
							<p><span className='font-medium'>Height: </span> {this.state.pokeInfo.height}</p>
